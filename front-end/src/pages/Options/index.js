                        ...
                        <Form.Item>
                            <div className="btns">
                                <div className="box" style={{width:150}}>
                                    ...
                                    <p style={{fontSize:12, fontWeight:"bold"}}>Importar arquivo para<br/>parametrização</p>
                                </div>
                                <div className="box" style={{marginTop:100, width:150}}>
                                <Image src={hdl} style={{display:'block',margin:'auto',width:60,height:60}}/>
                                <Link to='/handle'><Button style={{marginBottom:5}}>Manipulação</Button></Link>
                                <p style={{fontSize:12, fontWeight:"bold"}}>Manipular dados <br/>das tabelas</p>
                                </div>
                                <div className="box" style={{width:150}}>
                                <Image src={db} style={{display:'block',margin:'auto',width:60,height:60}}/>
                                <Link to='/postgresql'><Button style={{marginBottom:5}}>PostgreSQL</Button></Link>
                                <p style={{fontSize:12, fontWeight:"bold"}}>Converter dados para<br/>formato shapefile</p>
                                </div>
                            </div>
                        </Form.Item>
                    </Form>
